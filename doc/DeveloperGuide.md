...
1. User requests to list persons
2. AddressBook shows a list of persons
3. User requests to rename an existing tag of specific people in the list
4. AddressBook renames all people with existing tag to new tag <br>
Use case ends.
...
3a. The given existing tag is invalid
